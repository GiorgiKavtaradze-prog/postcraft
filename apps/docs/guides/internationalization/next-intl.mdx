...
description: 'Integrating Postcraft with next-intl'
'og:image': 'https://postcraft/static/covers/postcraft.png'
---

Postcraft supports [next-intl](https://next-intl.dev) for internationalization.
...
In the postcraft template, remove the hardcoded content and use `createTranslator` function to format the postcraft message strings.
...
<CardGroup>
  <Card
    title="Postcraft with next-intl example"
    icon='arrow-up-right-from-square'
    iconType="duotone"
    href="https://github.com/resend/postcraft-next-intl-example"
  >
