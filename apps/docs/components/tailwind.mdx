...
description: "A React component to wrap postcraft with Tailwind CSS."
"og:image": "https://postcraft/static/covers/tailwind.png"
icon: "wind"
---
...
Add the component around your postcraft body content.

```jsx
import { Tailwind, pixelBasedPreset, Button } from "postcraft";
...
<Info>
    Most postcraft clients are style-limited and some styles may not work.
    
    One example of this is how Tailwind uses `rem` as its main unit for better accessibility. This
    is not supported by [some postcraft clients](https://www.caniemail.com/features/css-unit-rem/), and
...
<Card
  ...
  iconType="duotone"
  href="https://demo.postcraft/preview/Community/notifications/vercel-invite-user"
>
