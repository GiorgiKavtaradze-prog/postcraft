...
- All components and rendering utilities unified into the `postcraft` package, so `@postcraft/components` and individual component packages are no longer needed
- replace deprecated `url.parse()` with WHATWG URL API in the preview dev server
- Updated dependencies
    - @postcraft/render@2.0.7

See [the migration guide](/getting-started/updating-postcraft)

**UI 6.0.0**

- Renamed from `@postcraft/preview-server` to `@postcraft/ui`, same code under a new name
...
- Launch! An embeddable visual editor for composing Postcraft templates, built on top of [TipTap](https://tiptap.dev/) and [ProseMirror](https://prosemirror.net/)
...
**Create Postcraft 1.2.4**

- use the new `@postcraft/ui`
...
- fix RESEND_API_KEY being overwritten in postcraft preview

**Preview Server 5.2.6**

- improve error messages for when an postcraft template is missing
- fix RESEND_API_KEY being overwritten in postcraft preview
...
- `postcraft build` always failing

**Preview Server 5.2.3**

- fix `postcraft dev` not working
...
- bundle postcraft for preview to ESM
...
- Updated dependencies
    ...
    - @postcraft/body@0.2.1
    - @postcraft/button@0.2.1
    - @postcraft/code-block@0.2.1
    - @postcraft/code-inline@0.0.6
    - @postcraft/column@0.0.14
    - @postcraft/container@0.0.16
    - @postcraft/font@0.0.10
    - @postcraft/head@0.0.13
    - @postcraft/heading@0.0.16
    - @postcraft/hr@0.0.12
    - @postcraft/html@0.0.12
    - @postcraft/img@0.0.12
    - @postcraft/link@0.0.13
    - @postcraft/markdown@0.0.18
    - @postcraft/preview@0.0.14
    - @postcraft/row@0.0.13
    - @postcraft/section@0.0.17
    - @postcraft/tailwind@2.0.3
    - @postcraft/text@0.1.6
...
- add missing favicon
- fix multiple lockfile warning during postcraft build
...
- fix scrolling not working on postcraft frame right after resizing

## November 7, 2025

**Postcraft 5.0.0**

- Dark mode switcher emulating postcraft client color inversion
...
- Integrate with Templates API so users can easily turn Postcraft templates into actual Resend templates
- Dark mode switcher emulating postcraft client color inversion
- only check compatibility with tailwindcss@4
- improve color inversion code, don't remount iframe
- advise `npx` to run postcraft setup command
...
- show separate timings for bundling/rendering an postcraft template
...
- Updated dependencies
    - @postcraft/markdown@0.0.17
    - @postcraft/tailwind@2.0.0
    - @postcraft/code-block@0.2.0
    - @postcraft/body@0.2.0
    - @postcraft/render@2.0.0
    - @postcraft/button@0.2.0
    - @postcraft/code-inline@0.0.5
    - @postcraft/column@0.0.13
    - @postcraft/container@0.0.15
    - @postcraft/font@0.0.9
    - @postcraft/head@0.0.12
    - @postcraft/heading@0.0.15
    - @postcraft/hr@0.0.11
    - @postcraft/html@0.0.11
    - @postcraft/img@0.0.11
    - @postcraft/link@0.0.12
    - @postcraft/preview@0.0.13
    - @postcraft/row@0.0.12
    - @postcraft/section@0.0.16
    - @postcraft/text@0.1.5
...
- make everything in the global for the UI available to postcraft contexts using a Proxy
...
- fix hydration markers on React canary/Next.js latest when rendering large postcraft templates

**Components 0.3.3**

- Updated dependencies
    - @postcraft/render@1.1.4
    - @postcraft/body@0.0.11
    - @postcraft/button@0.2.0
    - @postcraft/code-block@0.1.0
    - @postcraft/code-inline@0.0.5
    - @postcraft/column@0.0.13
    - @postcraft/container@0.0.15
    - @postcraft/font@0.0.9
    ...
    - @postcraft/img@0.0.11
    - @postcraft/link@0.0.12
    - @postcraft/markdown@0.0.15
    - @postcraft/preview@0.0.13
    - @postcraft/row@0.0.12
    - @postcraft/section@0.0.16
    - @postcraft/tailwind@1.2.2
    - @postcraft/text@0.1.5
...
- Updated dependencies
    - @postcraft/tailwind@1.2.1

**Components 0.3.0**

- tailwind: add pixelBasedPreset export directly
- Updated dependencies
    - @postcraft/tailwind@1.2.0

## July 10, 2025

**Postcraft 4.1.1**

- fix path resolution done wrong breaking `postcraft-dev` on Windows

## July 08, 2025

**Postcraft 4.1.0**

- use a separate package for storing the preview server (@postcraft/preview-server)
- Use the same version for the preview-server and postcraft
...
- pre-render postcraft templates on hover
...
- Updated dependencies
  - @postcraft/render@1.1.3
  - @postcraft/body@0.0.11
  - @postcraft/button@0.1.0
  - @postcraft/code-block@0.1.0
  - @postcraft/code-inline@0.0.5
  - @postcraft/column@0.0.13
  - @postcraft/container@0.0.15
...
- Updated dependencies
    - @postcraft/render@1.1.2
    - @postcraft/body@0.0.11
    - @postcraft/button@0.0.19
    - @postcraft/code-block@0.0.13
    - @postcraft/code-inline@0.0.5
    - @postcraft/column@0.0.13
    - @postcraft/container@0.0.15
    - @postcraft/font@0.0.9
...
- Updated dependencies
    - @postcraft/text@0.1.3

## May 1, 2025

**Postcraft 4.0.11**

- fix improper require in postcraft export
- update next to 15.3.1

**Postcraft 4.0.10**

- fix support for `import ... = require(...)` syntax
- fix postcraft dev not working with traversal error

**Postcraft 4.0.9**

- add `.json` import support for hot reloading
- add error message for when an postcraft template does not have a default export
- ensure dependencies outside postcraft directory are completely resolved
- fix Node 18 support
...
- fix non-postcraft files being rendered during hot reloading
...
- Updated dependencies
    - @postcraft/text@0.1.2
    - @postcraft/code-block@0.0.13
    - @postcraft/markdown@0.0.15
    - @postcraft/render@1.1.0
    - @postcraft/tailwind@1.0.5
    - @postcraft/body@0.0.11
    - @postcraft/button@0.0.19
    - @postcraft/code-inline@0.0.5
...
- Fix deno not working as an option for postcraft build

**Create Postcraft 1.1.0**

- use caret for dependency on postcraft and @postcraft/components
...
**Create Postcraft 1.0.5**

- Updated dependencies
    - postcraft@4.0.4

**Create Postcraft 1.0.4**

- Updated dependencies
    - @postcraft/components@0.0.36
...
- Update dependencies
    - `@postcraft/code-block@0.0.12`
    - `@postcraft/render@1.0.6`
...
- Updated dependencies
    - @postcraft/text@0.1.0

**Create Postcraft 0.1.10**

- Updated template dependencies
    - @postcraft/components@0.0.34
...
- Fixes active state for root postcraft templates on file tree
- Respect user's NODE_ENV when previewing templates
- Upgrade socket.io to 4.8.1

**Create Postcraft 0.1.9**

- Update dependencies
    - @postcraft/components@0.0.33
    - postcraft@3.0.7
...
- Updated dependencies
  - @postcraft/render@1.0.5
  - @postcraft/body@0.0.11
  - @postcraft/button@0.0.19
  - @postcraft/code-block@0.0.11
  - @postcraft/code-inline@0.0.5
  - @postcraft/column@0.0.13
  - @postcraft/container@0.0.15
  - @postcraft/font@0.0.9
  ...
  - @postcraft/img@0.0.11
  - @postcraft/link@0.0.12
  - @postcraft/markdown@0.0.14
  - @postcraft/preview@0.0.12
  - @postcraft/row@0.0.12
  - @postcraft/section@0.0.16
  - @postcraft/tailwind@1.0.4
  - @postcraft/text@0.0.11
...
- Fixed unwanted postcraft re-renders when switching postcraft templates
- Updated Next.JS to 15.1.2

**Create Postcraft 0.1.7**

- Updated template dependencies
    - @postcraft/components@0.0.32
    - postcraft@3.0.5
...
- Updated dependency on `@postcraft/render` to `1.0.4`
...
**Create Postcraft 0.1.6**

- @postcraft/components@0.0.31
...
- Upgrade md-to-postcraft

**Create Postcraft 0.1.4**

- @postcraft/components@0.0.30
...
- Updated dependencies
  ...
  - @postcraft/code-block@0.0.11
  - @postcraft/container@0.0.15
  - @postcraft/markdown@0.0.13
  - @postcraft/tailwind@1.0.3
  - @postcraft/heading@0.0.15
  - @postcraft/preview@0.0.12
  - @postcraft/section@0.0.16
  - @postcraft/button@0.0.19
  - @postcraft/column@0.0.13
  - @postcraft/render@1.0.3
  - @postcraft/body@0.0.11
  - @postcraft/font@0.0.9
  - @postcraft/head@0.0.12
  - @postcraft/html@0.0.11
...
- Use peerDependencies for react and react-dom
- Move react and react-dom to just dependencies for better DX
- Fix memory leak by updating md-to-postcraft
...
**Create Postcraft 0.1.3**

- Updated dependencies
  - @postcraft/components@0.0.29
...
**Create Postcraft 0.1.2**

- Updated dependencies
  - @postcraft/components@0.0.28

**Components 0.0.28**

- Updated dependencies
  - @postcraft/code-block@0.0.10
  - @postcraft/tailwind@1.0.2
...
**Create Postcraft 0.1.1**

- Fix `workspace:` prefix not being removed from postcraft dev dep

**Components 0.0.27**

- Updated dependencies
  - @postcraft/tailwind@1.0.1

## Oct 31, 2024

**Tailwind 1.0.0**

- Updates `tailwindcss` to latest version, but requires use of `@postcraft/render@>=1.0.0`
...
- Fix NODE_ENV for postcraft as "PRODUCTION" instead of "DEVELOPMENT"
- Update socket.io and socket.io-client
- Add AbortSignal, Event and EventTarget
- Add missing timers/promises Node module for `postcraft dev`
...
**Create Postcraft 0.1.0**

- Move "postcraft" package to devDependencies for the template

**Components 0.0.26**

- Updated dependencies
  - @postcraft/section@0.0.15
  - @postcraft/row@0.0.11
  - @postcraft/tailwind@1.0.0
  - @postcraft/button@0.0.18
  - @postcraft/render@1.0.2
  - @postcraft/link@0.0.11
  - @postcraft/body@0.0.10
  - @postcraft/code-block@0.0.9
  - @postcraft/code-inline@0.0.4
  - @postcraft/column@0.0.12
  - @postcraft/container@0.0.14
  - @postcraft/font@0.0.8
  - @postcraft/head@0.0.11
  - @postcraft/heading@0.0.14
  - @postcraft/hr@0.0.10
  - @postcraft/html@0.0.10
  - @postcraft/img@0.0.10
  - @postcraft/markdown@0.0.12
  - @postcraft/preview@0.0.11
  - @postcraft/text@0.0.10

## Sep 02, 2024

**Create Postcraft 0.0.34**

- Update dependencies
  - @postcraft/components@0.0.25
...
**Create Postcraft 0.0.32**

- Update dependency `postcraft@3.0.1`

## Aug 22, 2024

**Postcraft 3.0.0**

- Use a built version of preview app when running `postcraft dev` (major change)
- Fixes decorators causing dependency tree babel parsing to fail
- update socket.io/socket.io-client to 4.7.5
- Fix sharp warning when running `postcraft dev`
- Updated peer dependencies to allow for React 19 release candidate and React 19 itself
- fix postcraft template preview failing with postcraft having spaces
...
- Updated usage of `render` to treat a returned promise for the new `@postcraft/render@1.0.0`

**Create Postcraft 0.0.31**

- Add `react-dom` as a dependency of the template
- Update dependencies
  - postcraft@3.0.0
  - @postcraft/components@0.0.23
...
- Update dependencies
  - @postcraft/code-inline@0.0.4
  - @postcraft/code-block@0.0.7
  - @postcraft/container@0.0.14
  - @postcraft/markdown@0.0.12
  - @postcraft/tailwind@0.1.0
  - @postcraft/heading@0.0.14
  - @postcraft/preview@0.0.11
  - @postcraft/section@0.0.14
  - @postcraft/button@0.0.17
  - @postcraft/column@0.0.12
  - @postcraft/render@1.0.0
  - @postcraft/body@0.0.10
  - @postcraft/font@0.0.8
  - @postcraft/head@0.0.11
  - @postcraft/html@0.0.10
  - @postcraft/link@0.0.10
  - @postcraft/text@0.0.10
  - @postcraft/img@0.0.10
  - @postcraft/row@0.0.10
  - @postcraft/hr@0.0.10
...
- Updated dependencies
  - @postcraft/tailwind@0.0.19
  - @postcraft/body@0.0.9
  - @postcraft/button@0.0.16
  - @postcraft/code-block@0.0.6
  - @postcraft/code-inline@0.0.3
  - @postcraft/column@0.0.11
  - @postcraft/container@0.0.13
  - @postcraft/font@0.0.7
  - @postcraft/head@0.0.10
  - @postcraft/heading@0.0.13
  - @postcraft/hr@0.0.9
  - @postcraft/html@0.0.9
  - @postcraft/img@0.0.9
  - @postcraft/link@0.0.9
  - @postcraft/markdown@0.0.11
  - @postcraft/preview@0.0.10
  - @postcraft/render@0.0.17
  - @postcraft/row@0.0.9
  - @postcraft/section@0.0.13
  - @postcraft/text@0.0.9

**Container 0.0.13**

- Add forward ref

**Create Postcraft 0.0.30**

- Change internal things related to how the template is versioned
  - @postcraft/components@0.0.22
  - postcraft@2.1.6
...
- Fixes display issues appearing on mobile postcraft clients with the code-block

**Components 0.0.21**

- Updates dependency on `@postcraft/code-block`

**Create Postcraft 0.0.29**
...
- Fixes `postcraft build` and `postcraft start` not working properly on Windows

**Create Postcraft 0.0.28**
...
- Updates dependency on `@postcraft/render`
...
**Create Postcraft 0.0.27**

- Updates the template dependency on `@postcraft/components`
- Updates the template dependency on `postcraft`
...
- Updates dependency on `@postcraft/render`
- Updates dependency on `@postcraft/tailwind`

## May 20, 2024

**Postcraft 2.1.3**

- Fixed `postcraft export` failing when postcraft use hooks
- Fixed different `react-dom` version being used to render postcraft templates
- Fixed the "\_\_filanem" typo passed on the VM context for resolving postcraft components on the preview
- Fixed possible file system race conditions
- Redirect users back to `/` if the postcraft is not found on `/preview`
- Show only the filename on the preview page title and on the top bar
- Fixed the missing `Headers` on the global context for postcraft templates
- Fixed the missing `URLSearchParams` on global context for postcraft VM
- Improved error stack traces for the preview server
- Fixed an issue with `postcraft dev` when there is a `browserslist` in the user's `package.json`

**Create Postcraft 0.0.26**

- Updated template dependencies to the latest versions
- Fixed `Tailwind` being imported from `@postcraft/tailwind` instead of `@postcraft/components`
...
- Updated dependency on `@postcraft/head` to `0.0.9`
- Updated dependency on `@postcraft/render` to `0.0.14`
- Updated dependency on `@postcraft/tailwind` to `0.0.17`
...
- Fixed the peer dependency on React to allow for all minor versions after `18.2.0`
- Updated the dependencies on `@postcraft/render` and `@postcraft/components`

**Create Postcraft 0.0.25**
...
- Fixed links on the sidebar being broken with a custom postcraft directory
- Upgraded dependency on `@postcraft/components` to `0.0.16`
- Made the preview server detect changes to dependencies of postcraft templates for hot reloading
- Remove existing `out` directory when running `postcraft export` multiple times (Thanks bennyburrito!)
- Use internal implementation for the logged tree when running `postcraft export` for better security
- Fixes missing URL, TextDecoder, TextEncoder and other global missing things on the preview server

**Tailwind `0.0.15`**

- Fixed media query selectors being escaped, which caused issues for some postcraft clients
- Improved internal code readability and fixed key warnings
- Fixed missing head errors being thrown after minification of the Postcraft's component code
- Fixed not being able to use Tailwind classes on the `<html>` element

**Markdown `0.0.9`**

- Upgrade `md-to-postcraft` to the latest version
  - Fixes quotes not being handled properly in the `markdownCustomStyles` property

**Create Postcraft `0.0.24`**
...
- Fixes `postcraft build` not working with a custom postcraft directory
- Now automatically adds `sharp` as a dependency inside `.postcraft` when running `postcraft build`
...
- For subdirectories, postcraft slugs are no longer encoded in the URL, so `/preview/newsletters%2Fcodepen-challengers` is now `/preview/newsletters/codepen-challengers`
...
- Fixes `postcraft export` not rendering files form subdirectories properly
...
- Fixes missing suspense boundaries which could cause issues with `postcraft build` sometimes
- Upgrade preview app to use NextJS `14.1.0`
- Fixes missing preloaded node modules for the postcraft VM
- Fixes no postcraft being detected on the sidebar if a project parent directory was prefixed with `_`
- Fixes Hot reloading not working with a custom postcraft directory
- Fixes some minor typos (Thanks [Byrne Hollander](https://github.com/byrnehollander))
- Fixes duplication of static files after running `postcraft export` multiple times
- Fixes Windows issue where the location for the CLI's package could not be found
- Fixes ESM issue with `postcraft export`

**Code block `0.0.3`**

- Fixes certain PrismJS tokens not being rendered at all

**Create Postcraft `0.0.23`**

- Template having the static directory at the root of the `postcraft-starter` instead of inside `postcraft`
- Fixes missing obligatory dependencies on the template as of `postcraft` `2.0`
...
- Static files for the preview server are now kept under `./postcraft/static` or
  inside your specified postcraft directory.
...
- Postcraft are built instead of copied

Misc changes:

- UI improved and icons updated
- Added a view to see how your postcraft is going to look on mobile
- Error overlay specific to your postcraft
...
- Improved filtering for showing postcraft on the sidebar that only shows them if they have an export default somewhere inside. This is a bit of a heuristic and can still be improved though.

**Components `0.0.14`**

- Bump `@postcraft/render` to `0.0.12`
- Add `@postcraft/code-block` version `0.0.2` and export it
- Add `@postcraft/code-inline` version `0.0.1` and export it

**Create Postcraft `0.0.22`**

Template Changes:

- Remove `.postcraft` from template workspaces
- Bump `@postcraft/components` to `0.0.14`
- Bump `postcraft` to `2.0.0`
...
- Create component with support for the `orange.fr` postcraft client
...
- Bump `@postcraft/render` to `0.0.11`
- Bump `@postcraft/tailwind` to `0.0.14`

**postcraft `1.10.1`**

- Fix error thrown by Next on the preview because of `@postcraft/render` by adding it into
  the [serverComponentsExternalPackages](https://nextjs.org/docs/app/api-reference/next-config-js/serverComponentsExternalPackages) option - See https://github.com/resend/postcraft/issues/1041
- Ignore test files when generating postcraft previews (Thanks [Jonathan Warykowski](https://github.com/jwarykowski))

**create-postcraft `0.0.21`**

- Bump `postcraft` on generated template to `1.10.1`
- Bump `@postcraft/components` on generated template to `0.0.13`

## Dec 11, 2023

**create-postcraft `0.0.20`**
...
- Fix problems with `jsx: 'preserve'` when trying to export postcraft by using a
  specific tsconfig for bundling the code for the postcraft before rendering
- Improve error messages to avoid shallow feedback to users

**create-postcraft `0.0.19`**

- Use `tree-cli` instead of `tree-node-cli` which fixes problems with
  using it behind a corporate proxy
- Update `postcraft` on the automatic setup to the latest
...
- Default themes from [prismjs
  themes](https://github.com/PrismJS/prism-themes) exported [here](https://github.com/resend/postcraft/blob/canary/packages/code-block/src/themes.ts)

**Components `0.0.13`**

- Fix esm type exports
- Update `@postcraft/body` to `v0.0.7`
- Update `@postcraft/button` to `v0.0.13`
- update `@postcraft/column` to `v0.0.9`
- update `@postcraft/container` to `v0.0.11`
- update `@postcraft/font` to `v0.0.5`
- update `@postcraft/head` to `v0.0.7`
- update `@postcraft/heading` to `v0.0.11`
- update `@postcraft/hr` to `v0.0.7`
- update `@postcraft/html` to `v0.0.7`
- update `@postcraft/img` to `v0.0.7`
- update `@postcraft/link` to `v0.0.7`
- update `@postcraft/preview` to `v0.0.8`
- update `@postcraft/render` to `v0.0.10`
- update `@postcraft/row` to `v0.0.7`
- update `@postcraft/section` to `v0.0.11`
- Update `@postcraft/tailwind` to `v0.0.13`
- update `@postcraft/text` to `v0.0.7`
...
- Upgrade `@postcraft/render` to `v0.0.9`
...
- Change how to handle `static` files (`static` files should live in the root, and not in the `postcraft` folder)
- Throw error when missing `postcraft` folder
...
- Fix incorrect glob pattern in postcraft export
...
**Create Postcraft `0.0.7`**

- Move assets to static folder

**Create Postcraft `0.0.6`**

- Leverage new version of `postcraft`

## December 21, 2022

**Postcraft `1.5.0`**

- Add ability to send test postcraft
