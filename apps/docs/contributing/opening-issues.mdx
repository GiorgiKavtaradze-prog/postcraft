...
We ask that **issues are only opened for bugs**, and not for questions or feature requests. Questions and feature requests should be asked in [Discussions](https://github.com/resend/postcraft/discussions).
...
<div className="w-full flex">
  <a
    ...
    href="https://github.com/resend/postcraft/issues/new?assignees=&labels=Type%3A+Bug&projects=&template=1.bug_report.yml"
