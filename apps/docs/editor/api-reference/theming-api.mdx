...
description: "Types and utilities for the postcraft theming system."
icon: "swatchbook"
---

## EmailTheming extension

The `EmailTheming` extension from `@postcraft/editor/plugins` adds theme-aware styling
...
```tsx
import { extendTheme } from '@postcraft/editor/plugins';
...
```tsx
import { getMergedCssJs } from '@postcraft/editor/plugins';
...
```tsx
import { getResolvedNodeStyles } from '@postcraft/editor/plugins';
...
```tsx
import { getThemeComponentKey } from '@postcraft/editor/plugins';
...
```tsx
import { stylesToCss } from '@postcraft/editor/plugins';
...
```tsx
import { useEmailTheming } from '@postcraft/editor/plugins';
