...
description: "Set up the postcraft editor in your React project in under 5 minutes."
icon: "rocket"
---
...
See the [API Reference](/editor/api-reference/postcraft-editor) for details.
...
const content = `
  <h1>Welcome</h1>
  <p>This is a <a href="https://postcraft">link</a>.</p>
`;
...
[`composePostcraft`](/editor/api-reference/compose-postcraft), and the
...
<CardGroup cols={2}>
  <Card title="Standalone Editor — Minimal" icon="code" href="https://postcraft/editor/examples/standalone-editor">
    The simplest possible editor setup.
  </Card>
  <Card title="Basic Editor" icon="code" href="https://postcraft/editor/examples/basic-editor">
    EditorProvider with StarterKit and no overlays.
  </Card>
  <Card title="Standalone Editor — Full Features" icon="code" href="https://postcraft/editor/examples/standalone-editor-full">
