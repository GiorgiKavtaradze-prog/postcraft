...
description: "Add and edit postcraft buttons with the button bubble menu."
icon: "rectangle-wide"
---
...
const content = `
  ...
  <div class="align-left"><a class="node-button button" data-id="postcraft-button" href="https://postcraft">Click me</a></div>
...
<div class="align-left">
  <a class="node-button button" data-id="postcraft-button" href="https://postcraft">
    Click me
  </a>
</div>
```
...
as a styled button in the editor and serializes to a Postcraft `<Button>` component on export.
...
<CardGroup cols={2}>
  <Card title="Buttons" icon="code" href="https://postcraft/editor/examples/buttons">
