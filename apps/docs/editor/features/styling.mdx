...
The menu that appears when clicking an postcraft button
...
<Tip>
  ...
  editing. The exported postcraft HTML is styled separately via the [Theming](/editor/features/theming) system.
</Tip>
