...
<CardGroup cols={2}>
  <Card title="Bubble Menu" icon="code" href="https://postcraft/editor/examples/bubble-menu">
    Default bubble menu with text selection.
  </Card>
  <Card title="Custom Bubble Menu" icon="code" href="https://postcraft/editor/examples/custom-bubble-menu">
