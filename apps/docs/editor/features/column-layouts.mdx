...
Column layouts render as postcraft-safe tables. Space between columns is stored as the
...
<CardGroup cols={2}>
  <Card title="Column Layouts" icon="code" href="https://postcraft/editor/examples/column-layouts">
