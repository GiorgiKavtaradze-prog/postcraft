...
const content = `
  <p>Click on <a href="https://postcraft" target="_blank">this link</a> to see the link bubble menu.</p>
...
```tsx
const content = `
  <p>Visit <a href="https://postcraft" target="_blank">Postcraft</a> for more info.</p>
`;
```
...
<CardGroup cols={2}>
  <Card title="Link Editing" icon="code" href="https://postcraft/editor/examples/link-editing">
