...
/** Figma Postcraft-Templates `2681:2383` — Tech “order placed” card (Geist headline, line items, summary). */
                ...
                <Section className="mx-auto px-8 mobile:px-0">
                  <Section className="max-w-[420px]">
                    ...
                    <Text className="m-0 mt-6 font-14 font-sans text-fg-2">
                      ...
                      Halo rings for shipment and will postcraft the moment they
                      leave our warehouse.
                    </Text>
                    <Text className="m-0 mt-6 font-14 font-sans text-fg-2">
