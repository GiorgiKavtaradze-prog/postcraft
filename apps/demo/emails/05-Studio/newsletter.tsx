...
// https://github.com/resend/postcraft/tree/canary/apps/demo/emails
...
const techNewsletterLetterParagraphs = [
  ...
  "No inbox noise—just postcraft when restocks land, firmware improves, or there's something meaningful for members. Thanks for reading; we're happy you're along for the journey.",
];
...
/** Tech newsletter — same content blocks as Skin `newsletter.tsx`, light card layout (Figma Postcraft-Templates family). */
              ...
              <Section className="px-6 pt-2 pb-16 text-center">
                <Section className="mx-auto max-w-[320px]">
                  ...
                  <Text className="m-0 mt-5 font-11 font-sans text-fg-3">
                    ...
                    from {companyName} marketing postcraft.
                  </Text>
                </Section>
              </Section>
            </Section>
