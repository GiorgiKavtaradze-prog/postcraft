...
const textOnlyParagraphs = [
  'This is the text-only layout: no hero image and no primary call-to-action. Use it for concise product notes, receipts, account updates, and other plain-language postcraft where the message should stay front and center.',
