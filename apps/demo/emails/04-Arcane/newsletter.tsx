...
const newsletterLetterParagraphs = [
  ...
  'No inbox clutter—just postcraft when we have something worth your time. Thanks for letting us sit next to your morning serum and your evening wind-down.',
];
