...
const description = 'Open source templates built with Postcraft';

export const metadata: Metadata = {
  title: 'Templates — Postcraft',
  description,
  alternates: {
    canonical: '/templates',
  },
    ...
    <PageWrapper>
      ...
      <PageTransition className="pb-10" key="templates" tag="main">
        <div className="flex w-full flex-col gap-2 px-6 pt-16 pb-10 md:px-8">
          ...
          <p>
            {description}. Recreate an existing postcraft or submit a{' '}
            <Anchor
              href="https://github.com/resend/postcraft/tree/main/apps/demo/postcraft"
              target="_blank"
            >
              pull request
            </Anchor>{' '}
