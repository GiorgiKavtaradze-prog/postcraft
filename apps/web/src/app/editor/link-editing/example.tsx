...
const content = `
  <p>Click on <a href="https://postcraft" target="_blank" rel="noopener noreferrer">this link</a> to see the link bubble menu. You can edit the URL, open the link, or unlink it.</p>
