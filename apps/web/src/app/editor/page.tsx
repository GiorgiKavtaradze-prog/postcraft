    ...
    examples: [
      {
        ...
        docsUrl: 'https://postcraft/docs/editor/getting-started',
      },
      {
      ...
      },
      {
        ...
        docsUrl: 'https://postcraft/docs/editor/features/inspector',
      },
    ],
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        docsUrl: 'https://postcraft/docs/editor/features/bubble-menu',
      },
      {
        slug: 'slash-commands',
        ...
        docsUrl: 'https://postcraft/docs/editor/features/slash-commands',
      },
    ],
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        docsUrl: 'https://postcraft/docs/editor/features/link-editing',
      },
      {
        slug: 'column-layouts',
        title: 'Column layouts',
        description: 'Insert multi-column layouts using the toolbar buttons.',
        docsUrl: 'https://postcraft/docs/editor/features/column-layouts',
      },
      {
        slug: 'buttons',
        title: 'Buttons',
        ...
        docsUrl: 'https://postcraft/docs/editor/features/buttons',
      },
      {
        slug: 'image-upload',
        title: 'Image upload',
        ...
        docsUrl: 'https://postcraft/docs/editor/features/image-upload',
      },
    ],
  },
  {
    ...
    examples: [
      {
        slug: 'email-theming',
        title: 'Postcraft theming',
        description:
          'Switch between Basic, Minimal, and Custom themes to see how postcraft styles change.',
      ...
      },
      {
        ...
        description:
          'A custom Callout node created with EmailNode.create — showing how to extend the editor with postcraft-compatible nodes.',
        docsUrl: 'https://postcraft/docs/editor/advanced/custom-extensions',
      },
      {
        ...
        docsUrl: 'https://postcraft/docs/editor/overview',
      },
      {
...
export const metadata: Metadata = {
  ...
  description:
    'Interactive examples showing how to build Postcraft editors with @postcraft/editor.',
  alternates: {
    canonical: '/editor',
  },
};
    ...
    <PageWrapper>
      <PageTransition className="pb-10" key="editor-examples" tag="main">
        <div className="flex w-full flex-col gap-2 px-6 pt-16 pb-10 md:px-8">
          ...
          <p>
            Interactive examples showing how to build postcraft editors with
            @postcraft/editor.
          </p>
        </div>
