  ...
  content: [
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'This is a themed postcraft editor. Toggle between Basic, Minimal, and Custom themes to see how styles change.',
        },
      ],
    },
    {
...
export function EmailThemingExample() {
  ...
  return (
    <ExampleShell
      ...
      description="Switch between Basic, Minimal, and Custom themes to see how postcraft styles change."
    >
