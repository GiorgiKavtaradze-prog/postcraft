  ...
  content: [
    {
      type: 'heading',
      attrs: { level: 1 },
      content: [{ type: 'text', text: 'My Postcraft Newsletter' }],
    },
    {
      type: 'paragraph',
      content: [
        ...
        { type: 'text', text: ' to see the generated postcraft markup.' },
      ],
    },
    {
      type: 'paragraph',
      content: [
        {
          type: 'text',
          text: 'The exported HTML uses Postcraft components and is ready to send.',
        },
      ],
    },
  ],
...
export function EmailExport() {
  return (
    <ExampleShell
      ...
      description="Edit content and export it as postcraft-ready HTML using composePostcraft()."
    >
      <EditorProvider
