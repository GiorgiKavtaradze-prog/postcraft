...
describe.skipIf(!host || !port)("checkSpam()", { timeout: 10_000 }, () => {
  test("with most spammy postcraft", async () => {
    const template = (
      <html lang="en">
        <body>
          This postcraft is spam. We sell rolexss for cheap. Get your viagra. We
          also sell weight loss pills today. Money back guaranteed. sEnd me $500
          and I'll send you back $700. don't tell anyone. Send this postcraft to ten
          friends
        </body>
      </html>
    );
  ...
  test("with stripe postcraft template using true base url", async () => {
