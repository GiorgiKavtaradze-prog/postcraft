...
export const metadata: Metadata = {
  title: "Components - Postcraft",
  description:
    "Build beautiful postcraft with pre-built components that you can copy-and-paste into your app.",
  openGraph: {
    images: [{ url: "https://postcraft/static/covers/patterns.png" }],
  },
  alternates: {
    ...
    <PageWrapper>
      ...
      <PageTransition className="pb-10" key="about" tag="main">
        <div className="flex w-full flex-col gap-2 px-6 pt-16 pb-10 md:px-8">
          ...
          <p>
            Build beautiful postcraft with pre-built components that you can
