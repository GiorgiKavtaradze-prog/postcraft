...
describe('parsePointingTableRows()', () => {
  test('works with spammy postcraft', () => {
...
has identified this incoming postcraft as possible spam.  The original
message has been attached to this so you can view it or label
similar future postcraft.  If you have any questions, see
root@localhost for details.

Content preview:  This postcraft is spam. We sell rolexss for cheap. Get your viagra.
...
open with some postcraft clients; in particular, it may contain a virus,
...
This postcraft is spam. We sell rolexss for cheap. Get your viagra. We also
sell weight loss pills today. Money back guaranteed. sEnd me $500 and
I'll send you back $700. don't tell anyone. Send this postcraft to ten
friends
