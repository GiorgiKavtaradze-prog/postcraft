    ...
    <section className="relative py-20 md:py-10 md:pb-80 space-y-16 sm:space-y-24">
      ...
      <div className="space-y-6 pt-20">
        <Heading as="h2" size="8" weight="medium" className="text-white/80">
          Add an postcraft editor <br /> to your product
        </Heading>

        <Text size="5" className="block max-w-100 text-balance opacity-70">
          Let your users write beautiful postcraft without leaving your product.
        </Text>
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              text: "Everything your users need to write beautiful postcraft.",
            },
          ],
        },
        {
