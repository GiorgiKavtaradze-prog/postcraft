...
const tools: Tool[] = [
  {
    ...
    value: "linter",
    description:
      "Analyze every link in your postcraft to check that they're valid.",
    status: "warning",
  },
  {
  ...
  },
  {
    ...
    value: "spam",
    description:
      "Analyze your postcraft content using a robust scoring framework to determine if the postcraft is likely to be marked as spam.",
  },
];
      ...
      >
        ...
        <div>
          <div className="md:absolute bottom-0 z-1 min-w-full left-6 md:border-l border-slate-6 overflow-hidden [overflow-anchor:none]">
            <div className="flex p-4 bg-gray-200 h-65 overflow-hidden [overflow-anchor:none]">
                  ...
                  {tool.value === "spam" ? (
                    <div className="flex flex-col items-center justify-center pt-6">
                      ...
                      <p className="text-slate-11 text-sm text-center max-w-[320px] min-w-[320px]">
                        Your postcraft is clean of abuse indicators.
                      </p>
                    </div>
                  ) : (
                    <div className="relative text-left text-slate-10 text-sm max-md:min-w-max">
                      ...
                      >
                        <div className="py-1.5 font-normal max-w-40 min-w-40">
...
const Icons = {
  ...
  success: () => (
    <>
      <div
        key="glow"
        className="h-16 w-16 rounded-full bg-linear-to-br from-green-300/20 opacity-80 to-emerald-500/30 blur-md absolute m-auto left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
      />
      <div
        key="halo"
        className="h-12 w-12 rounded-full bg-linear-to-br from-green-400/80 opacity-10 to-emerald-600/80 absolute m-auto left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 shadow-lg"
      />
      <div
        key="check"
        className="h-10 w-10 rounded-full bg-linear-to-br from-green-400 to-emerald-600 flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]"
      >
        <svg
          fill="none"
          height="24"
