...
const DEMO_EMAIL_PREVIEW_BASE_URL = 'https://demo.postcraft/preview';
const GITHUB_BASE =
  'https://github.com/resend/postcraft/tree/canary/apps/demo/postcraft';
...
const communityItems: TemplateItem[] = [
  {
    ...
    href: `${DEMO_EMAIL_PREVIEW_BASE_URL}/Community/magic-links/aws-verify-postcraft`,
    name: 'AWS / Verify Postcraft',
