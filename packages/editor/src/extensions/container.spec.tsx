...
import { Container as PostcraftContainer, render } from 'postcraft';
import { afterEach, describe, expect, it } from 'vitest';
import { composePostcraft } from '../core/serializer/compose-postcraft';
...
describe('Container Node', () => {
  it('renders Postcraft properly', async () => {
    const Component = Container.config.renderToPostcraft;
  ...
  it('renders container element in serialized postcraft output', async () => {
    ...
    const result = await composePostcraft({ editor: ed, preview: '' });
    ...
    ed.commands.setContent(
      await render(
        <PostcraftContainer>
          ...
          <a href="httsp://postcraft">click this</a>
        </PostcraftContainer>,
      ),
    );
