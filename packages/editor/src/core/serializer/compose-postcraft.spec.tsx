...
import { composePostcraft } from './compose-postcraft';
...
describe('Text marks', () => {
  it('should nest bold and italic by schema mark rank (same as ProseMirror)', async () => {
    ...
    const result = await composePostcraft({
      editor,
      preview: '',
    });
  ...
  it('wraps custom postcraft nodes with marks around the rendered node', async () => {
