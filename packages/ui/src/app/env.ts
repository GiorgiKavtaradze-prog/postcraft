...
export const userProjectLocation =
  process.env.POSTCRAFT_INTERNAL_USER_PROJECT_LOCATION!;

/** ONLY ACCESSIBLE ON THE SERVER */
export const previewServerLocation =
  process.env.POSTCRAFT_INTERNAL_PREVIEW_SERVER_LOCATION!;

/** ONLY ACCESSIBLE ON THE SERVER */
export const emailsDirectoryAbsolutePath =
  process.env.POSTCRAFT_INTERNAL_EMAILS_DIR_ABSOLUTE_PATH!;

/** ONLY ACCESSIBLE ON THE SERVER */
export const resendApiKey = process.env.POSTCRAFT_INTERNAL_RESEND_API_KEY;
