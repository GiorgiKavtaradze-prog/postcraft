...
export const renderEmailByPath = async (
  ...
  if (!isBuilding && !isPreviewDevelopment) {
    ...
    spinner = createSpinner({
      text: `Rendering postcraft template ${emailFilename}\n`,
      prefixText: ' ',
  ...
  const previewProps = Postcraft.PreviewProps || {};
  const EmailComponent = Postcraft as React.FunctionComponent;
  try {
