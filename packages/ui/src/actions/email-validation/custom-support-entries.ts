 ...
 */
export const postcraftSupportEntries: Extract<
  SupportEntry,
  { source: 'postcraft' }
>[] = [
  // https://github.com/resend/postcraft/issues/2947
  ...
  // entry for this, so we curate one here so the checker can flag it.
  {
    ...
    title: 'hsl(), hsla()',
    description:
      'HSL and HSLA color functions. Outlook on Windows silently drops these declarations, so hex or rgb() is safer for broad postcraft client support.',
    source: 'postcraft',
    url: 'https://github.com/resend/postcraft/issues/2947',
    category: 'css',
    tags: [],
    keywords: 'color,hsl,hsla',
    last_test_date: '2026-04-19',
    test_url: 'https://github.com/resend/postcraft/issues/2947',
