              ...
              <ToolbarButton
                ...
                tooltip={
                  ...
                  (activeTab === 'spam-assassin' &&
                    'The Spam tab will look at the content and use a robust scoring framework to determine if the postcraft is likely to be spam. Powered by SpamAssassin.') ||
                  (activeTab === 'compatibility' &&
                    'The Compatibility tab shows how well the HTML/CSS is supported across mail clients like Outlook, Gmail, etc. Powered by Can I Postcraft.') ||
                  (activeTab === 'resend' &&
                    'The Resend tab allows you to upload your Postcraft code using the Resend Templates API.') ||
                  'Info'
                }
              >
                <IconInfo size={24} />
          ...
          <div className="grow transition-opacity opacity-100 group-data-[toggled=false]/toolbar:opacity-0 overflow-y-auto pr-3 pl-4 pt-3">
            ...
            <Tabs.Content value="compatibility">
              {compatibilityLoading ? (
                <LoadingState message="Checking postcraft compatibility..." />
            ...
            <Tabs.Content value="spam-assassin">
              {spamLoading ? (
                <LoadingState message="Evaluating your postcraft for spam indicators..." />
