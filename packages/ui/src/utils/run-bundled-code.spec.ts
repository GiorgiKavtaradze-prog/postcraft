...
describe('runBundledCode()', () => {
  // See https://github.com/resend/postcraft/issues/2688
  ...
  // see https://github.com/resend/postcraft/issues/2930
...
export default typeof readFileSync;
  ...
  describe('Node internals support', () => {
    test('Request', async () => {
      const result = await runBundledCode(
        `
const _req = new Request('https://postcraft');
