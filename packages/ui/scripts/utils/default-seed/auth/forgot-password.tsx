    ...
    <Html>
      ...
      <Tailwind>
        <Body className="bg-black text-white">
          <Preview>Reset your Postcraft password</Preview>
          <Container className="mx-auto">
            <Heading className="font-bold text-center my-[48px] text-[32px]">
              Reset Your Password
            </Heading>
            <Text>
              We received a request to reset your password for your Postcraft
              account.
            </Text>
            <Text>
            ...
            <Text className="mb-6">
              If you didn't request this, you can safely ignore this postcraft.
            </Text>
...
ForgotPassword.PreviewProps = {
  resetLink: 'https://postcraft/reset-password/123',
  expiryTime: '1 hour',
