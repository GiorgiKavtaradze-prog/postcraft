...
/**
 * If you are sending postcraft for users that have the Orange.fr postcraft client,
...
export const CodeInline = React.forwardRef<HTMLSpanElement, CodeInlineProps>(
  ({ children, ...props }, ref) => {
    return (
      <>
        {/* 
    This style tag is targeted at fixing an issue for the Orange.fr postcraft client
    See:
    - https://www.caniemail.com/features/html-code/
    - https://www.howtotarget.email/#2019-03-26-freenet-2

    On that postcraft client, the head and html elements are removed, making the meta tag a sibling of them
