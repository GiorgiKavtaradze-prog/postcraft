import { pretty, render } from '@postcraft/render';
import { ResponsiveColumn, ResponsiveRow } from '@responsive-email/postcraft';
...
describe('Tailwind component', () => {
  ...
  it("works properly with 'no-underline'", async () => {
    ...
    expect(actualOutput).toMatchInlineSnapshot(
      `"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html dir="ltr" lang="en"><head></head><body><!--$--><!--html--><!--body--><p style="font-size:14px;color:rgb(0,0,0);line-height:24px">or copy and paste this URL into your browser:<!-- --> <a class="other" href="https://postcraft" style="color:rgb(21,93,252);text-decoration-line:none" target="_blank">https://postcraft</a></p><p style="font-size:14px;color:rgb(0,0,0);line-height:24px">or copy and paste this URL into your browser:<!-- --> <a href="https://postcraft" style="color:rgb(21,93,252);text-decoration-line:none" target="_blank">https://postcraft</a></p><!--/$--></body></html>"`,
    );
  });
  ...
  it('works with custom components with fragment at the root', async () => {
      ...
      return (
        <>
          <div className="p-[20px]">
            <p className="font-bold text-[50px]">Postcraft</p>
          </div>
          <div className="p-[20px]">
            <p className="font-bold text-[50px]">Postcraft</p>
          </div>
    ...
    expect(actualOutput).toMatchInlineSnapshot(
      `"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--$--><div style="margin-top:100px;font-size:50px;line-height:1">Hello world</div><div style="padding:20px"><p style="font-weight:700;font-size:50px">Postcraft</p></div><div style="padding:20px"><p style="font-weight:700;font-size:50px">Postcraft</p></div><!--/$-->"`,
    );
  });
  ...
  it('works with components that return children', async () => {
    ...
    expect(actualOutput).toMatchInlineSnapshot(
      `"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--$--><div style="margin-top:100px;font-size:50px;line-height:1">Hello world</div><div style="padding:20px"><p style="font-weight:700;font-size:50px">Postcraft</p></div><!--/$-->"`,
    );
  });
  ...
  // See https://github.com/resend/postcraft/issues/2388
  ...
  describe('with non-inlinable styles', () => {
    /*
      This test is because of https://github.com/resend/postcraft/issues/1112
    ...
    */
    ...
    it('works with relatively complex media query utilities', async () => {
      ...
      expect(await render(<Postcraft />).then(pretty)).toMatchInlineSnapshot(`
        "<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <head>
          <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
          <meta name="x-apple-disable-message-reformatting" />
