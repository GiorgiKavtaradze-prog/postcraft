...
test('postcraft export', { retry: 3 }, async () => {
  const pathToEmailsDirectory = path.resolve(__dirname, './postcraft');
                    ...
                    <tr style="width:100%">
                      <td>
                        ...
                        <p
                          ...
                          expecting this invitation, you can ignore this postcraft. If
                          you are concerned about your account&#x27;s safety, please
                          reply to this postcraft to get in touch with us.
                        </p>
                      </td>
                    </tr>
                  </tbody>
