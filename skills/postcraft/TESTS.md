...
❌ WITHOUT explicit rule: Agents imported from `@postcraft/tailwind` or `@postcraft/tailwind/presets` in 2/5 tests.

**Verified Result (2026-02-12):**
✅ WITH explicit rule: 4/5 agents imported from `postcraft`. Pressure test (D1) still used wrong import path.
...
**Expected Behavior:**
Use the official Postcraft pattern:
