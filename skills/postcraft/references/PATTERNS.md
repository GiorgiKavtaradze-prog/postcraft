# Common Postcraft Patterns

Real-world examples of common postcraft templates using Postcraft with Tailwind CSS styling.

## Table of Contents

- [Password Reset Postcraft](#password-reset-postcraft)
- [Order Confirmation with Product List](#order-confirmation-with-product-list)
- [Notification Postcraft with Code Block](#notification-postcraft-with-code-block)
- [Multi-Column Newsletter](#multi-column-newsletter)
- [Team Invitation Postcraft](#team-invitation-postcraft)
...
export default function PasswordReset({ resetUrl, postcraft, expiryHours = 1 }: PasswordResetProps) {
  return (
    <Html lang="en">
        ...
        <Body className="bg-gray-100 font-sans">
          ...
          <Container className="mx-auto py-10 px-5 max-w-xl bg-white">
            ...
            <Text className="text-base leading-7 text-gray-800 my-4">
              A password reset was requested for your account: <strong>{postcraft}</strong>
            </Text>
            <Text className="text-base leading-7 text-gray-800 my-4">
            ...
            <Text className="text-sm text-gray-500 leading-5 my-2">
              If you didn't request this, please ignore this postcraft. Your password will remain unchanged.
            </Text>
            <Text className="text-sm text-gray-500 leading-5 my-2">
        ...
        <Body className="bg-gray-100 font-sans">
          ...
          <Container className="mx-auto py-10 px-5 max-w-xl">
            ...
            <Text className="text-sm text-gray-500 mt-8">
              Questions about your order? Reply to this postcraft and we'll help you out.
            </Text>
          </Container>
        </Body>
      </Tailwind>
...
## Notification Postcraft with Code Block
        ...
        <Body className="bg-gray-100 font-mono">
          ...
          <Container className="mx-auto max-w-xl bg-white border border-solid border-gray-200 rounded overflow-hidden">
            ...
            <Text className="text-xs text-gray-500 mx-6 mb-6">
              This is an automated notification. Please do not reply to this postcraft.
            </Text>
          </Container>
        </Body>
      </Tailwind>
      ...
      <Tailwind config={{ presets: [pixelBasedPreset] }}>
        ...
        <Body className="bg-gray-100 font-sans">
          ...
          <Container className="mx-auto py-10 px-5 max-w-xl bg-white">
            ...
            <Text className="text-sm text-gray-500 leading-5 my-2">
              If you weren't expecting this invitation, you can safely ignore this postcraft.
            </Text>
          </Container>
        </Body>
      </Tailwind>
