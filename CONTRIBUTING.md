...
- ✏️ A clear and descriptive title
...
2. ✍️ **Write a clear description** — Explain _what_ you changed and _why_.
...
- 📌 **Type of change**: Feature / Bug fix / Docs / Refactor / etc.
...
3. ✍️ Write a summary of the change (this appears in the CHANGELOG)
